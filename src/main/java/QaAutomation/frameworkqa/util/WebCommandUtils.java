...
import QaAutomation.frameworkqa.Loginpage.Loginpage;
import QaAutomation.frameworkqa.Loginpage.checkoutloginpage;
import QaAutomation.frameworkqa.Loginpage.pdpsizeselect;
	...
	public Object executeAction(WebDriver driver, WebElement element,
		...
		if(true){
			...
			case "ScrollToElement":
				Navigate.scrollToElement(driver, element);
				break;		
			case "KeyboardPageUp":
			...
			case "Checkoutlogin":
				checkoutloginpage.Checkoutlogin(driver);	
				break;	
			case "pdpsize":
				pdpsizeselect.pdpsize(driver);
			}
